...
#include "../stats_manager/stats_manager.hpp" // Stats manager for handling stats
...
class SceneLoader {
    ...
    /**
     * @brief Load the stats from the Lua table.
     * @param stats The Lua table containing the stats.
     */
