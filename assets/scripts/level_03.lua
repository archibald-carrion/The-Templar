scene = {
    ...
    music = {
        ...
        {music_id = "level_03_music",file_path ="./assets/sounds/Title_v1.mp3"},
    ...
    entities = {
        ...
        -- music player
        {
            components = {
                script = {
                    path = "./assets/scripts/music_level_03.lua"
                },
            }
        },
        ...
        -- door fourth level
        {
            components = {
                ...
                script = {
                    path = "./assets/scripts/goto_level_04_door.lua"
                },
                transform = {
                    position = { x = 3136*2, y = 768*2},
                    scale = { x = 1.0, y = 1.0},
                    rotation = 0.0
                },
            }
